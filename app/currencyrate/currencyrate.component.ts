...
//   selectedFromCountry: ExchangeRate | null = null;
//   selectedToCountry: ExchangeRate | null = null;
...
//         const totalFee = this.amount - ourFee; // Calculate the total fee as (You Send Exactly - Our Fee)
//         const recipientReceives = totalFee / fromRate * toRate; // Calculate the amount the recipient receives
